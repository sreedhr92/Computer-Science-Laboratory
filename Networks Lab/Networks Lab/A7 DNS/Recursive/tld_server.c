...
int main(int argc,char **argv)
{
    ...
    while(1)
    {
        ...
        {
            printf("\n**The Ip is not available in the TLD server redirecting to Authoritative server..**\n");
            serverAddr.sin_port=htons(1000);//connecting to the port of authoritative sever..
            ret = bind(sockfd,(struct sockaddr*)&serverAddr,sizeof(serverAddr));
