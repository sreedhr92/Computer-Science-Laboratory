...
The concatenated string is goodboy

Enter the choice :2
Enter the source string :sreedhar
Enter the no. of characters to be copied to the destination(upto):4
The Copied string is sree

Enter the choice :3
Enter the string :sreedhar

Enter the character to find the positon :e
2 is the first occurance

Enter the choice :4
Enter the string :sreedhar
Enter the character to be replaced in the string :e
The Modified string is eeeeeeee
...
Enter the choice :6
Enter the source string :sree
Enter the destinaton string :string
Enter the no. of characters to be copied to the destnation(atmost):4
The concatenated string is sreestri*/